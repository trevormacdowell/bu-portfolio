...
env.project_name = 'prime' # name of project module in root of repo
env.gitsource = 'git@github.com:trevormacdowell/bu-portfolio.git' # full path (filesystem or git: to .git repo)
env.server_owner = 'prime-svc'
